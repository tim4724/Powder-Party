...
// through a real session: name entry -> lobby -> drive -> finish.
...
var CONTROLLER_CARDS = [
  ...
  { key: 'results-series',  title: 'Results (mid-series)', perColor: true },
  { key: 'results',         title: 'Results (series, host)', perColor: true },
  { key: 'results-waiting', title: 'Results (series, waiting)', perColor: true },
...
// the display page's preference. view-as covers all MAX_PLAYERS skier colours.
var MAX_PLAYERS = 4;
var CTRL_MAX_COLS = 8;
